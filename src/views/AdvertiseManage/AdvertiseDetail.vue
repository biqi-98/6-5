  ...
  <el-card class="form-container" shadow="never">
    ...
    <el-form :model="homeAdvertise" :rules="rules" ref="form" label-width="150px" size="small">
      ...
      <el-form-item label="开始时间：" prop="startTime">
        <el-date-picker type="datetime" placeholder="选择日期" v-model="homeAdvertise.startTime" format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
      </el-form-item>
      <el-form-item label="到期时间：" prop="endTime">
        <el-date-picker type="datetime" placeholder="选择日期" v-model="homeAdvertise.endTime" format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
      </el-form-item>
  ...
  methods: {
    ...
    handleSave() {
      this.$refs.form.validate(valid => {
        ...
        this.homeAdvertise.startTime = formatDate(this.homeAdvertise.startTime,"yyyy-MM-dd hh:mm:ss");
        this.homeAdvertise.endTime = formatDate(this.homeAdvertise.endTime,"yyyy-MM-dd hh:mm:ss");
